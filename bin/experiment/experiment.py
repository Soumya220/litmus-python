...
import experiments.kube_aws.ec2_terminate_by_tag.experiment.ec2_terminate_by_tag as ec2TerminateByTAG
import argparse
import logging
...
def main():
	...
	elif args.name == "ec2terminatebytag":
		ec2TerminateByTAG.Experiment(clients)
