...
def GetENV(experimentDetails):
	experimentDetails.ExperimentName =  os.getenv("EXPERIMENT_NAME", "ec2terminatebytag")
	...
	experimentDetails.InstanceTag = os.getenv("INSTANCE_TAG", "Experiment")
	experimentDetails.InstanceRegion = os.getenv("INSTANCE_REGION", "ap-aouth-1")
	#experimentDetails.InstanceTAG = os.getenv("INSTANCE_ID", "")
...
def InitialiseChaosVariables(chaosDetails, experimentDetails):
	...
	chaosDetails.InstanceTag = experimentDetails.InstanceTag
